...
class PropertyItem : public QObject {
 ...
 public:
  enum class Property {
    ...
    // Plot3D Scatter (graph-level)
    Plot3DScatter_Base_Separator,
    Plot3DScatter_AspectRatio,
    Plot3DScatter_HorizontalAspectRatio,
    Plot3DScatter_ShadowQuality,
    Plot3DScatter_OrthoProjection,
    Plot3DScatter_Polar,
    // Plot3D Scatter DataBlock (series-level)
    Plot3DScatterDB_Base_Separator,
    Plot3DScatterDB_Visible,
    Plot3DScatterDB_Size,
    Plot3DScatterDB_MeshSmooth,
    Plot3DScatterDB_ColorStyle,
    Plot3DScatterDB_SolidColor,
    Plot3DScatterDB_GradientColor,
    Plot3DScatterDB_HighlightColor,
    // Plot3D Bar (graph-level)
    Plot3DBar_Base_Separator,
    Plot3DBar_AspectRatio,
    Plot3DBar_HorizontalAspectRatio,
    Plot3DBar_ShadowQuality,
    Plot3DBar_OrthoProjection,
    Plot3DBar_Polar,
    Plot3DBar_Spacing_Separator,
    Plot3DBar_RelativeSpacing,
    Plot3DBar_SpacingX,
    Plot3DBar_SpacingY,
    Plot3DBar_Thickness,
    // Plot3D Bar DataBlock (series-level)
    Plot3DBarDB_Base_Separator,
    Plot3DBarDB_Visible,
    Plot3DBarDB_MeshSmooth,
    Plot3DBarDB_ColorStyle,
    Plot3DBarDB_SolidColor,
    Plot3DBarDB_GradientColor,
    Plot3DBarDB_HighlightColor,
    // Plot3D Surface (graph-level)
    Plot3DSurface_Base_Separator,
    Plot3DSurface_AspectRatio,
    Plot3DSurface_HorizontalAspectRatio,
    Plot3DSurface_ShadowQuality,
    Plot3DSurface_FlipHorizontalGrid,
    Plot3DSurface_OrthoProjection,
    Plot3DSurface_Polar,
    // Plot3D Surface DataBlock (series-level)
    Plot3DSurfaceDB_Base_Separator,
    Plot3DSurfaceDB_Visible,
    Plot3DSurfaceDB_FlatShading,
    Plot3DSurfaceDB_DrawMode,
    Plot3DSurfaceDB_MeshSmooth,
    Plot3DSurfaceDB_ColorStyle,
    Plot3DSurfaceDB_SolidColor,
    Plot3DSurfaceDB_GradientColor,
    Plot3DSurfaceDB_HighlightColor,
  };
